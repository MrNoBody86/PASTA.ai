...
export default function App() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <DrawerContentScrollView 
          {...props} 
          contentContainerStyle={{ backgroundColor: '#dde3fe', padding: 0 }}>
          ...
          <View style={{ padding: 30 }}>
            ...
            />
            <Text 
              style={{ fontWeight: 500, fontSize: 20, paddingTop: 20, color: '#5363df' }}>
              {user?.email}
            </Text>
          </View>
        ...
        <View style={{
          ...
          <DrawerItem 
            ...
            style={{ backgroundColor: 'white', width: 310 }} 
            labelStyle={{ fontSize: 16, fontWeight: 100 }}
  ...
  function InsideLayout() {
    return (
      <Drawer.Navigator 
        initialRouteName="Personality Test"
